...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, brandName: $brandName, category: $category, model: $model, price: $price, description: $description, imageUrl: $imageUrl, specifications: $specifications)';
  }
